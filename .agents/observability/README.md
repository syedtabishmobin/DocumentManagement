...
Project binding is in `.agents/project/observability.json`. Validate with `pnpm verify:observability`; query with `pnpm agent:status`, `pnpm agent:tree`, and `pnpm agent:summary`.
