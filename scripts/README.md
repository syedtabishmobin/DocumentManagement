...
Use `python3 scripts/github_attribution.py render ...` to generate the mandatory normalized footer for agent-authored material GitHub records and `validate <file>` before publication.
