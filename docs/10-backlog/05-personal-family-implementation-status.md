...
| `STORY-P1-006` | `IN IMPLEMENTATION` | Issue #58 extends the durable IngestionCase/outbox established by Stories P1-004 and P1-005. | Add stable stage-run execution keys, lease/attempt state, duplicate/reordered/crash-window convergence, bounded retry/DLQ repair, current authorization/quarantine/deletion fences, truthful generic job/cancellation views and independent resilience QA. |
