...
| `STORY-P1-006` | `QA FAILED — ISOLATED` | Issue #58 / PR #59 contain an unmerged durable staged-workflow candidate at `1c84f44`. Protected CI passed, but independent QA found defect #60: repeated expired-lease takeovers bypass bounded retry exhaustion. | Keep PR #59 unmerged; fix #60 across file/PostgreSQL restart boundaries, return an exact `FIX_READY` candidate, and independently retest Story P1-006 plus P1-001–005 regression after the Product Authority queue pause is lifted. |
