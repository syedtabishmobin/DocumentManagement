...
| `P0` | `FIX READY — QA PENDING` | Issue #58 / PR #59 now bound retryable failures and expired-lease worker loss to one three-attempt execution-generation budget, with one terminal/dead-letter outcome and newer-generation-only repair. Protected CI and independent exact-candidate retest of defect #60, Story P1-006 and P1-001–005 regression remain required before merge; analysis-generation runtime remains later governed work. | `STORY-P1-004`, `006`, `015` |
