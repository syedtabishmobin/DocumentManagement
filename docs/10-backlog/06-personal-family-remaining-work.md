...
| `P0` | `INCOMPLETE — QUEUE PAUSED` | Issue #58 / PR #59 provide an isolated durable ingestion-stage candidate, but independent defect #60 proves expired-lease worker-loss retries can bypass bounded exhaustion. Preserve the branch and fix/retest that boundary before merge; analysis-generation runtime remains later governed work. | `STORY-P1-004`, `006`, `015` |
