...
| Version | `0.1` |
| Status | **DRAFT — no story is implementation-ready or authorized** |
| Product phase | Phase 1 — Personal and Family |
| Sequence basis | Proposed `P1-S1`–`P1-S4` under `DEC-030` |
...
All stories are `DRAFT` unless explicitly `BLOCKED`. Owners are accountable roles. Product/catalogue, architecture/security/API/UX/engineering/operations/reference contracts remain their own source of truth. The reference-data records named below are DRAFT/disabled seeds unless an approved publication changes them; names are exact configuration identities, not hard-coded implementation values.
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Product + Identity/Workspace |
...
|---|---|
| State / owner | `DRAFT`; Product + Identity/Workspace |
| Product | `REQ-P1-WS-003`; `FEAT-P1-001`; `UC-P1-001`; `OUT-P1-005` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Security + Authorization |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Platform + UX |
...
| Future TEST | `TEST-UNIT-P1-003`, `TEST-UNIT-P1-004`, `TEST-CON-P1-002`, `TEST-CON-P1-006`, `TEST-SEC-P1-009`, `TEST-SEC-P1-010`, `TEST-SEC-P1-015`, `TEST-E2E-P1-002`, `TEST-PERF-P1-005`, `TEST-DR-P1-001`, `TEST-DR-P1-002`; DRAFT cases require execution/accessibility evidence. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — final clinical disposition BLOCKED by DEC-036`; Security + Document Platform |
...
| Dependencies / fences | Depends on `STORY-P1-004`; scanner timeout/unavailability and suspicion remain contained; `DEC-036` forbids choosing reject/quarantine/retain timing/disposition; `DEC-024` excludes clinical records. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Platform |
| Product | `REQ-P1-ING-004`; `FEAT-P1-004`; `UC-P1-002`; `OUT-P1-007` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Platform + Security |
...
| Future TEST | `TEST-UNIT-P1-003`, `TEST-CON-P1-002`, `TEST-CON-P1-006`, `TEST-SEC-P1-006`, `TEST-SEC-P1-009`, `TEST-SEC-P1-014`, `TEST-E2E-P1-003`, `TEST-PERF-P1-003`, `TEST-PERF-P1-006`, `TEST-DR-P1-001`, `TEST-DR-P1-004`, `TEST-DR-P1-006`, `TEST-DR-P1-008`; DRAFT cases require execution/accessibility evidence. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Security + Platform |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — UC-P1-019 catalogue-only`; Security/Privacy + Observability |
| Product | `REQ-P1-TRUST-003`, `REQ-P1-TRUST-004`; `FEAT-P1-006`; `UC-P1-013`, `UC-P1-019`; `OUT-P1-007`; **`TRACE-GAP-P1-UC-001`** |
...
| Dependencies / fences | Applies to every story; telemetry, audit, events, provenance, analytics, and protected evidence stay distinct; `DEC-039` leaves retention durations unset and `DEC-040` makes unknown routes ineligible. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — launch activation BLOCKED by DEC-035`; Reference-data Governance + Platform |
...
| Dependencies / fences | Validator checks schema, unique/dangling/typed IDs, safe endpoints, cross-pack references, decision fences, and inert Phase 2 types; publication/activation is `STORY-P1-037`; `DEC-035` prohibits launch coverage inference. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Platform + Product |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Intelligence |
| Product | `REQ-P1-ING-005`; `FEAT-P1-009`; `UC-P1-003`, `004`; `OUT-P1-002`, `OUT-P1-007` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — launch types/schemas BLOCKED by DEC-035`; Document Intelligence |
| Product | `REQ-P1-ING-006`; `FEAT-P1-009`; `UC-P1-002`, `003`; `OUT-P1-002`, `OUT-P1-007` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Intelligence + UX |
| Product | `REQ-P1-ING-007`; `FEAT-P1-009`; `UC-P1-003`, `004`; `OUT-P1-002` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Intelligence + Platform |
| Product | `REQ-P1-ING-008`; `FEAT-P1-009`; `UC-P1-002`, `003`, `012`; `OUT-P1-002`, `OUT-P1-007` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Domain/Data + Document Intelligence |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Security/Privacy + Document Intelligence |
...
|---|---|
| State / owner | `DRAFT`; Domain/Data + Document Intelligence |
| Product | `REQ-P1-GPH-001`, `REQ-P1-GPH-002`; `FEAT-P1-012`; `UC-P1-004`, `005`, `013`; `OUT-P1-003`, `OUT-P1-005` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Search + Security |
| Product | `REQ-P1-SRCH-001`, `REQ-P1-SRCH-003`; `FEAT-P1-013`; `UC-P1-005`, `013`; `OUT-P1-004`, `OUT-P1-005` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; AI/Search + Product |
| Product | `REQ-P1-SRCH-002`, `REQ-P1-SRCH-004`; `FEAT-P1-013`; `UC-P1-005`; `OUT-P1-004`, `OUT-P1-007` |
...
| Future TEST | `TEST-CON-P1-003`, `TEST-CON-P1-011`, `TEST-AI-P1-009`–`TEST-AI-P1-012`, `TEST-AI-P1-015`, `TEST-SEC-P1-003`, `TEST-SEC-P1-004`, `TEST-SEC-P1-010`, `TEST-SEC-P1-015`, `TEST-E2E-P1-005`, `TEST-PERF-P1-003`, `TEST-PERF-P1-004`, `TEST-PERF-P1-010`, `TEST-DR-P1-005`, `TEST-DR-P1-008`; DRAFT cases require execution/accessibility evidence. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Search/Document Platform + UX |
| Product | `REQ-P1-SRCH-005`; `FEAT-P1-013`; `UC-P1-003`, `005`; `OUT-P1-002`, `OUT-P1-004` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; AI Platform + Security |
| Product | `REQ-P1-AI-001`, `REQ-P1-AI-002`, `REQ-P1-AI-003`; `FEAT-P1-014`; `UC-P1-005`; `OUT-P1-002`, `OUT-P1-004`, `OUT-P1-007` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; AI Assurance + Product/Security |
| Product | `REQ-P1-AI-004`, `REQ-P1-AI-005`, `REQ-P1-AI-006`, `REQ-P1-AI-007`; `FEAT-P1-014`; `UC-P1-002`, `004`, `005`, `007`; `OUT-P1-002`, `OUT-P1-004`, `OUT-P1-007` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Document Intelligence + Domain/Data |
| Product | `REQ-P1-DOC-008`; `FEAT-P1-015`; `UC-P1-003`, `006`; `OUT-P1-002`, `OUT-P1-003` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Monitoring + Document Intelligence |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — launch source pack BLOCKED by DEC-035`; Source Governance + Monitoring |
...
|---|---|
| State / owner | `DRAFT`; Monitoring + Document Intelligence |
| Product | `REQ-P1-MON-006`; `FEAT-P1-018`; `UC-P1-006`, `007`; `OUT-P1-003` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Product Workflow + Document Intelligence |
| Product | `REQ-P1-ACT-001`, `REQ-P1-ACT-002`, `REQ-P1-ACT-003`, `REQ-P1-ACT-004`; `FEAT-P1-018`; `UC-P1-004`, `007`, `008`; `OUT-P1-003`, `OUT-P1-006` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Product Workflow + Security |
| Product | `REQ-P1-ACT-005`, `REQ-P1-ACT-006`; `FEAT-P1-019`; `UC-P1-004`, `007`; `OUT-P1-003`, `OUT-P1-006` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Product Workflow + Integration/Security |
| Product | `REQ-P1-ACT-007`, `REQ-P1-ACT-008`; `FEAT-P1-019`; `UC-P1-007`; `OUT-P1-003`, `OUT-P1-006` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — launch profiles BLOCKED by DEC-035`; Document Intelligence + Product |
| Product | `REQ-P1-HLT-001`, `REQ-P1-HLT-002`, `REQ-P1-HLT-003`; `FEAT-P1-020`; `UC-P1-008`; `OUT-P1-006`, `OUT-P1-007` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Product + Document Intelligence |
| Product | `REQ-P1-HLT-005`; `FEAT-P1-020`; `UC-P1-008`; `OUT-P1-006` |
| UX / accessibility | `UX-FLOW-P1-012`, `027`; `UX-SCR-P1-024`, `042`; `UX-DS-P1-001`–`040`; `A11Y-P1-001`–`035`, `038`, `039`, `042`–`056` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Product Workflow + UX |
| Product | `REQ-P1-NTF-001`, `REQ-P1-NTF-002`, `REQ-P1-NTF-003`; `FEAT-P1-021`; `UC-P1-007`, `008`, `010`; `OUT-P1-006` |
...
| Future TEST | `TEST-UNIT-P1-009`, `TEST-CON-P1-005`, `TEST-CON-P1-008`, `TEST-SEC-P1-002`, `TEST-SEC-P1-013`, `TEST-SEC-P1-015`, `TEST-E2E-P1-007`, `TEST-E2E-P1-008`, `TEST-E2E-P1-010`, `TEST-PERF-P1-001`, `TEST-PERF-P1-002`, `TEST-PERF-P1-006`, `TEST-DR-P1-002`, `TEST-DR-P1-008`; DRAFT cases require execution/accessibility evidence. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — UC-P1-018 catalogue-only; launch activation BLOCKED by DEC-035`; Configuration Governance |
| Product | `REQ-P1-CFG-002`, `REQ-P1-CFG-003`, `REQ-P1-CFG-004`; `FEAT-P1-022`; `UC-P1-018`; `OUT-P1-007`; **`TRACE-GAP-P1-UC-001`** |
...
| Dependencies / fences | Depends on `STORY-P1-009`, `010`; separate proposal/review/approval/publication/activation/supersession/rollback; required consumer compatibility/ack; catalogue-only UC lacks detailed product AC until closed. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Security/Privacy + Product Workflow |
| Product | `REQ-P1-SHR-005`; `FEAT-P1-023`; `UC-P1-007`, `010`, `013`; `OUT-P1-005`, `OUT-P1-006` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT`; Product + Authorization/Privacy |
| Product | `REQ-P1-SHR-001`, `REQ-P1-SHR-002`, `REQ-P1-SHR-003`, `REQ-P1-WS-006`; `FEAT-P1-024`; `UC-P1-009`, `011`, `013`; `OUT-P1-005`, `OUT-P1-006` |
...
| Future TEST | `TEST-UNIT-P1-002`, `TEST-CON-P1-001`, `TEST-CON-P1-006`, `TEST-SEC-P1-001`, `TEST-SEC-P1-002`, `TEST-SEC-P1-006`, `TEST-SEC-P1-008`, `TEST-E2E-P1-009`, `TEST-E2E-P1-011`, `TEST-E2E-P1-013`, `TEST-PERF-P1-002`, `TEST-PERF-P1-006`, `TEST-DR-P1-002`, `TEST-DR-P1-008`; DRAFT cases require execution/accessibility evidence. |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — UC-P1-015 catalogue-only; detailed product AC missing`; Product + Identity/Privacy |
| Product | `REQ-P1-WS-007`; `FEAT-P1-025`; `UC-P1-015`; `OUT-P1-005`; **`TRACE-GAP-P1-UC-001`** |
| UX / accessibility | `UX-FLOW-P1-002`, `030`; `UX-SCR-P1-006`, `045`; `UX-DS-P1-001`–`040`; `A11Y-P1-001`–`035`, `043`–`056`, especially `047`, `049` |
| API / events | Adjacent subject/membership operations `API-P1-104`–`111`; no dedicated dependant-transition operation; `EVT-P1-002`, `003`; **`TRACE-GAP-P1-API-013`** |
...
| Reference data | No dependant-transition policy catalogue exists: **`TRACE-GAP-P1-REF-003`**; current `data/access-control.json` default deny/role/action records remain the only active-safe baseline. |
| Dependencies / fences | Depends on `STORY-P1-002`, `003`, `039`; transition evidence/consent/age/jurisdiction/notice/challenge/appeal/private-resource rules require product approval; relationship/maturity alone does not transfer credentials, ownership, grants, or content. |
| Migration / rollback / repair | Stable subject identity and prior authority/evidence history survive any future transition; use an explicit fenced case with revision/approval; rollback/appeal is a new decision, not rewriting prior relationships/access. |
| Negative, failure, audit | Premature/false age/event, family-admin assertion, identity mismatch, missing consent/evidence, private-resource expansion, support/recovery bypass, concurrent policy/grant change; no transition until detailed contract closes; audit attempts safely. |
...
- `AC-STORY-P1-040-01` — **Given** a managed dependant and no approved transition contract, **when** age, relationship, membership, support, or asserted consent changes, **then** subject provenance remains intact and no ownership/credential/private-resource authority transfers automatically.
- `AC-STORY-P1-040-02` — **Given** a future approved transition case, **when** it is eventually implemented, **then** this story cannot be closed until exact evidence, consent, notice, challenge, appeal, grant, private-resource, migration, and test IDs replace `TRACE-GAP-P1-UC-001`/`REF-003`.

### `STORY-P1-041` — Preserve disabled connector consent and conformance boundaries

| Field | Contract |
|---|---|
| State / owner | `BLOCKED — DEC-031 and DEC-040`; Integration + Security/Privacy |
| Product | `REQ-P1-ING-009`, `REQ-P1-TRUST-009`; `FEAT-P1-026`; `UC-P1-014`; `OUT-P1-001`, `OUT-P1-007`; **`TRACE-GAP-P1-UC-001`** |
...
| Future TEST | `TEST-UNIT-P1-010`, `TEST-CON-P1-005`, `TEST-CON-P1-012`, `TEST-SEC-P1-010`, `TEST-SEC-P1-013`–`TEST-SEC-P1-015`, `TEST-E2E-P1-014`, `TEST-PERF-P1-001`, `TEST-PERF-P1-006`, `TEST-PERF-P1-008`, `TEST-DR-P1-008`; DRAFT disabled-boundary cases require execution evidence. |

- `AC-STORY-P1-041-01` — **Given** `DEC-031` or `DEC-040` is unresolved, **when** any connector creation, sync, action, callback, or credential path is invoked, **then** it remains disabled/fails closed without token, external request, household disclosure, or inferred launch scope.
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — external delivery BLOCKED by DEC-037 and DEC-040`; Product Workflow + UX/Privacy |
| Product | `REQ-P1-NTF-004`; `FEAT-P1-027`; `UC-P1-010`; `OUT-P1-006` |
...
| Dependencies / fences | Depends on `STORY-P1-036`, `038`; channel, category, privacy/content policy, consent, quiet/escalation/delivery success remain separate; external failure never changes task/action/fulfilment. |
...
| Future TEST | `TEST-CON-P1-005`, `TEST-CON-P1-012`, `TEST-SEC-P1-002`, `TEST-SEC-P1-012`, `TEST-SEC-P1-013`, `TEST-SEC-P1-015`, `TEST-E2E-P1-010`, `TEST-PERF-P1-001`, `TEST-PERF-P1-002`, `TEST-PERF-P1-006`, `TEST-DR-P1-002`, `TEST-DR-P1-008`; DRAFT cases require execution/accessibility evidence. |
...
- `AC-STORY-P1-042-02` — **Given** `DEC-037`/`040` is unresolved or consent/route/current authority is absent, **when** email/push/other external delivery is requested, **then** no dispatch or success/escalation claim occurs.

### `STORY-P1-043` — Show item-level health while aggregate scoring stays absent

| Field | Contract |
|---|---|
| State / owner | `BLOCKED — aggregate score under DEC-034`; Product + UX/AI Assurance |
| Product | `REQ-P1-HLT-004`; `FEAT-P1-028`; `UC-P1-008`; `OUT-P1-006` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — envelope completeness unapproved under DEC-033; routes constrained by DEC-040`; Product + Privacy/Platform |
| Product | `REQ-P1-TRUST-006`; `FEAT-P1-029`; `UC-P1-011`; `OUT-P1-005`, `OUT-P1-006` |
...
| Field | Contract |
|---|---|
| State / owner | `DRAFT — durations and retained-audit treatment BLOCKED by DEC-039; routes by DEC-040`; Privacy + Platform/Operations |
| Product | `REQ-P1-TRUST-007`; `FEAT-P1-029`; `UC-P1-012`; `OUT-P1-005`, `OUT-P1-007` |
...
| Reference data | `data/access-control.json`: `action.trash`, `action.restore`, `action.purge`; deletion/fence states in `data/states-and-severity.json`; no timing/retention value exists or may be invented. |
...
| Field | Contract |
|---|---|
| State / owner | `BLOCKED — production route matrix under DEC-040`; Architecture + Security/Privacy/Operations |
| Product | `REQ-P1-TRUST-005`; `FEAT-P1-030`; `UC-P1-011`–`013`; `OUT-P1-005`, `OUT-P1-007` |
...
| Future TEST | `TEST-UNIT-P1-010`, `TEST-CON-P1-005`, `TEST-CON-P1-012`, `TEST-SEC-P1-010`–`TEST-SEC-P1-015`, `TEST-E2E-P1-013`, `TEST-E2E-P1-014`, `TEST-E2E-P1-020`, `TEST-PERF-P1-001`, `TEST-PERF-P1-006`, `TEST-PERF-P1-008`–`TEST-PERF-P1-010`, `TEST-DR-P1-004`, `TEST-DR-P1-006`, `TEST-DR-P1-008`; DRAFT blocked-route cases require execution/accessibility evidence. |
...
| Field | Contract |
|---|---|
| State / owner | `BLOCKED — DEC-038`; Security + Product |
| Product | `REQ-P1-TRUST-008`; `FEAT-P1-030`; `UC-P1-017`; `OUT-P1-005`, `OUT-P1-007`; **`TRACE-GAP-P1-UC-001`** |
...
| Field | Contract |
|---|---|
| State / owner | `BLOCKED — DEC-032`; Product + Security/Privacy |
| Product | `REQ-P1-SHR-004`; `FEAT-P1-025`; `UC-P1-016`; `OUT-P1-005`; **`TRACE-GAP-P1-UC-001`** |
