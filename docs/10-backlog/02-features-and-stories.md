...
| Field | Contract |
|---|---|
| State / owner | `BASELINED — PLANNED_UNISSUED; approved POLICY_HOLD boundary`; Security + Document Platform |
...
| Field | Contract |
|---|---|
| State / owner | `BASELINED — PLANNED_UNISSUED`; Document Platform |
