...
- `UX-SCR-P1-045` — Every open-decision screen or branch MUST remain unavailable/disabled with accurate explanatory copy and an approved alternative; prototypes and deep links MUST NOT expose a latent active route.
