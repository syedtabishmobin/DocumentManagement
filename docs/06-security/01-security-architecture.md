...
| `SEC-P1-005` | MFA enrolment, use, reset, and recovery MUST NOT provide a weaker ownership or private-resource path; approved `DEC-038` excludes a recovery success design from Phase 1. | `REQ-P1-TRUST-008`, `JRN-P1-010` | No fallback bypass under the approved capability fence. |
