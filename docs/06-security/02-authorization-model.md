...
| `AUTH-P1-032` | Recovery cannot change identity, ownership, factors, keys, or private-resource authority under approved Phase 1 `DEC-038`; any future ceremony requires a later governed decision and no support-only bypass. | `REQ-P1-TRUST-008` | Account takeover/recovery abuse suite. |
