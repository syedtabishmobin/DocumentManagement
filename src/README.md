...
The current local vertical flow includes separate email/password identities; scrypt password storage; hashed, bounded and revocable sessions; CSRF/origin/sign-in-abuse controls; idempotent personal/family workspace creation; multiple isolated local workspaces; distinct owner/subject/identity-link/membership/grant/authorization-epoch records; and explicit workspace, purpose and deny-by-default action authorization. React and Flutter carry this request context, fetch protected originals/exports through authorized requests, and truthfully keep recovery/ownership transfer policy-blocked.

The document experience includes household subjects distinct from login memberships, person-linked file/camera/manual capture, hierarchical category browsing, controlled document dossiers and original viewing, deterministic evidence-linked profile extraction, human review, typed person/document/category/fact connections, an accessible relationship map/list, cited local Q&A, tasks, family access administration, activity history, and immediate deletion fencing with a server-authored 30-day Trash/restore deadline. React web and Flutter mobile also share exact AES-256-GCM known-answer vectors.
