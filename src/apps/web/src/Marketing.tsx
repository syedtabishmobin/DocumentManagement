...
export function MarketingSite() {
  ...
  return <div className="marketing-site">
    ...
    <main className="marketing-main">
      ...
      <section className="marketing-band" aria-label="Product principles"><span>One connected workspace</span><span>Human-controlled intelligence</span><span>Visible evidence</span><span>Private synthetic testing</span></section>
      ...
      <section className="intelligence-section" id="intelligence">
        ...
        <div className="answer-preview"><div className="answer-preview-head"><span><Sparkles /> Ask Doculyra</span><small>PRIVATE RETRIEVAL</small></div><p className="sample-question">When does our home insurance renew?</p><div className="sample-answer"><strong>Renewal is listed for 18 September.</strong><p>The current policy schedule contains that date. Review the policy directly before acting.</p><blockquote><FileSearch /><span><b>Home insurance schedule</b><small>Page 2 · Current authorised version</small></span></blockquote></div><footer><ShieldCheck /> Evidence shown before action</footer></div>
      </section>
      ...
      <section className="security-section" id="security"><div><span className="eyebrow light">Privacy and security</span><h2>Private by default. Connected only by choice.</h2><p>{localRuntime ? "The local development profile stores and processes synthetic documents on this machine." : "The Azure development preview accepts synthetic test data only."} Future identity, document-platform and hosted-AI connections stay inactive until their purpose, scope, consent, credentials and conformance checks are configured.</p><ul><li><Check /> Passwords are strongly hashed; raw session tokens are not stored</li><li><Check /> Family relationship never grants automatic document access</li><li><Check /> AI assistance cannot approve its own consequential action</li><li><Check /> Activity records avoid document content and sensitive values</li></ul></div><div className="security-card"><ShieldCheck /><strong>Your data boundary stays visible.</strong><p>Doculyra distinguishes local processing, configured connections and unavailable capabilities instead of presenting a simulated success.</p></div></section>
...
function ProductPreview() {
  return <div className="product-preview" aria-label="Doculyra product preview"><div className="preview-top"><span><BrandMark /><b>My household</b></span><em>Private workspace</em></div><div className="preview-body"><aside><i className="active" /><i /><i /><i /><i /></aside><section><small>WORKSPACE OVERVIEW</small><h2>Your records, in order.</h2><div className="preview-stats"><span><b>18</b>Documents</span><span><b>3</b>People</span><span><b>2</b>Next actions</span></div><article><span><FolderKanban /></span><div><strong>Home insurance</strong><small>Alex & Sam · renewal in 24 days</small></div><em>Organised</em></article><article><span><Sparkles /></span><div><strong>Ask Doculyra</strong><small>Evidence available from 12 authorised records</small></div><em>Cited</em></article></section></div></div>;
}
