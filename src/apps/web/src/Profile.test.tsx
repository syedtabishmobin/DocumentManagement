...
const snapshot: DashboardSnapshot = {
  workspace: { id: "workspace-synthetic", name: "Synthetic household", type: "FAMILY", status: "ACTIVE", ownerBindingId: "owner-binding-synthetic", jurisdictionPackRef: "jurisdiction.AU", residencyPolicyRef: "residency.local.synthetic", configurationVersion: "configuration.local.synthetic@0.1", revision: 1, createdAt: "2026-08-28T00:00:00.000Z" },
  ...
  subjects: [{ id: "subject-synthetic", workspaceId: "workspace-synthetic", displayName: "Synthetic Person", kind: "OWNER", relationship: "Self", status: "ACTIVE", validFrom: "2026-08-28T00:00:00.000Z", recordedAt: "2026-08-28T00:00:00.000Z", createdAt: "2026-08-28T00:00:00.000Z", revision: 1, history: [] }],
  members: [], tasks: [], notifications: [], audit: [], accessGrants: [], authorizationEpoch: { workspaceId: "workspace-synthetic", value: 1, cause: "WORKSPACE_CREATED", advancedAt: "2026-08-28T00:00:00.000Z" }, localMode: true, customerDataPolicy: "synthetic-only",
};
