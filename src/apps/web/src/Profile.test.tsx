...
const snapshot: DashboardSnapshot = {
  ...
  subjects: [{ id: "subject-synthetic", workspaceId: "workspace-synthetic", displayName: "Synthetic Person", kind: "OWNER", relationship: "Self", createdAt: "2026-08-28T00:00:00.000Z", revision: 1 }],
